...
export namespace ProtractorBrowser {
    namespace By {
        function addLocator(name: any, script: any): void;
        function binding(bindingDescriptor: any): any;
        function buttonText(searchText: any): any;
        function byRepeaterInner(exact: any, repeatDescriptor: any): any;
        function className(name: any): any;
        function css(selector: any): any;
        function cssContainingText(cssSelector: any, searchText: any): any;
        function deepCss(selector: any): any;
        function exactBinding(bindingDescriptor: any): any;
        function exactRepeater(repeatDescriptor: any): any;
        function id(id: any): any;
        function js(script: any, var_args: any, ...args: any[]): any;
        function linkText(text: any): any;
        function model(model: any): any;
        function name(name: any): any;
        function options(optionsDescriptor: any): any;
        function partialButtonText(searchText: any): any;
        function partialLinkText(text: any): any;
        function repeater(repeatDescriptor: any): any;
        function tagName(name: any): any;
        function xpath(xpath: any): any;
    }
}
...
export class WebDriver {
    ...
    static createSession(executor: any, capabilities: any, opt_flow: any, opt_ctor: any, opt_onQuit: any): any;
...
export namespace promise {
    ...
    class Promise {
        ...
        constructor(resolver: any, opt_flow: any);
        flow_: any;
        stack_: any;
        stack_: any;
        parent_: any;
